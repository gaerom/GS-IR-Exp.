...
def get_scales(key, cameras, images, points3d_ordered, args):
    ...
    n_remove = len(image_meta.name.split('.')[-1]) + 1 # 4
...
if __name__ == '__main__':
    ...
    parser.add_argument('--base_dir', default="./avnerf2/release/1")
    parser.add_argument('--depths_dir', default="/mnt/storage1/3DGS/gaussian-splatting/depth/1/depths")
